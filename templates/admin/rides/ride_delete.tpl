...
{include file="head.tpl"}
  <title>{#app_full_name#} | Admin | Rides | {$ride.name} | DELETE</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/admin/rides/{$ride.id}/delete"><i class="fa fa-trash"></i> Delete</a></li>
     </ol>
    </section>
...
<legend>Are you sure you wish to delete {$ride.name}?</legend>
