...
{include file="head.tpl"}
  <title>{#app_full_name#} | Admin | Queue scrapers | Ridetimes.co.uk | {$ride.name}/{$ride.ride_id}</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/admin/queuescrapers/ridetimescouk/{$ride.id}/edit"><i class="fa fa-pencil"></i> Edit</a></li>
     </ol>
    </section>
...
<div class="form-group">
  ...
  <div class="col-md-4">
	...
	{foreach item=rideoption from=$rides}
		<option value="{$rideoption.id}" {if $ride.id eq $rideoption.id}selected{/if}>{$rideoption.name}</option>
	{/foreach}
    </select>
  </div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<input id="ride_id" name="ride_id" type="ride_id" placeholder="" class="form-control input-md" required="" value="{$ride.ride_id}">
	</div>
</div>
