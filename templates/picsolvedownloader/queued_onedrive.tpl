...
{include file="head.tpl"}
  <title>{#app_full_name#} | Picsolve | Downloader | Onedrive</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
		<p>ParkPlanr will shortly save all of the photos in your Picsolve account to a Onedrive folder called ParkPlanr</p>
